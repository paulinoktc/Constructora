  ...
  <div class="container"> 
    ...
    <section id="content">
      <div class="inside">
        ...
        <h2>Credito<span> Fovisste</span></h2>
        
        <div class="img-box"><img src="images/fovissste.png"><span class="txt1">¿Que es Fovissste?</span> 
          <p>Es el organismo encargado del otorgamiento de créditos para vivienda a los trabajadores al servicio del estado. 
          El Fondo de la Vivienda es el órgano desconcentrado del (ISSSTE), encargado de administrar las aportaciones de las 
          dependencias y entidades públicas, afiliadas al ISSSTE, constituidas para otorgar créditos para la adquisición, 
          reparación, ampliación o mejoramiento de viviendas a los trabajadores del Estado.</p>
        </div>
      </div>

      <div class="requisitos">                  
        <a href="http://www.fovissste.gob.mx/es/FOVISSSTE/Simulador" target="blank">Ir al simulador de credito</a>
        <a href="http://www.fovissste.gob.mx/" target="blank">Ir al sitio oficial</a>
      <h5>Requisitos FOVISSSTE tradicional:</h5>
        <ul>          
          <li>Incribirse al sorteo</li>
          <li>Consultar si es acreedor del credito</li>
          <li>Creedencial de elector</li>
          <li>CURP</li>
          <li>Comprobante de domicilio</li>
          <li>Ultimos 3 talones de pago</li>
          <li>Acta de nacimiento</li>
          <li>Constancia de servicios (Otorgada por la SEP)</li>
          <li>Ultimo estado de cuenta del SART</li>
          <li>Acta de matrimonio (Si es casado)</li>
        </ul>
      </div>
    </section>
  </div>
