  ...
  <div class="container"> 
    ...
    <section id="content">
      <div class="inside">
        ...
        <h2>Credito<span> Infonavit</span></h2>
        
        <div class="img-box"><img src="images/infonavit.png"><span class="txt1">¿Que es el Infonavit? </span> 
	        <p>El Instituto del Fondo Nacional de la Vivienda para los Trabajadores, o Infonavit como casi todos lo conocemos, 
          es un organismo que se denomina tripartita en virtud de que son tres las partes que trabajan de manera conjunta en 
          su estructura; el gobierno, las empresas y los trabajadores.</p>
        </div>
      </div>
      <div class="requisitos">
        <a href="http://portal.infonavit.org.mx/wps/wcm/connect/infonavit/trabajadores/precalificacion_y_puntos/precalificacion_y_puntos" target="blank">
            Ir al sitio Infonavit
        </a>
        <h5>Requisitos:</h5>
        <ul>           
           ...
           <li>IFE</li>
           <li>Ultimo estado de cuenta de AFORE</li>
