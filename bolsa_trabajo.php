    ...
    <!-- BOLSA DE TRABAJO -->
      ...
      <div class = "promo">
        ...
        <div class="requisitos">
          Te invitamos a formar parte de nuestro equipo de trabajo como asesor inmobiliario.
          <h5>Requisitos:</h5>
          <ul>
            <li>Tener preparotoria o equivalente.</li>
            <li>Conocimientos basicos en computación.</li>
        ...
        <form id="contacts-form" action="php/bolsaTrabajo_enviar.php" method="POST" enctype="multipart/form-data">
          <fieldset>
            <div class="field">
              <label>Nombre:</label>
            ...
            <div class="field">
              ...
              <input name="curriculum" type="file" value="" required/>
            </div>

            <div class="field extra">
              <label>Comentarios:</label>
              <textarea name="comentario" cols="1" rows="1" required></textarea>
            </div>
            <input class="enviar" type="submit" name="" value="Enviar Solicitud">
          </fieldset>
        </form>
      </div>
    </section>
