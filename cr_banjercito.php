...
<div class="wrap"> 
  ...
  <div class="container"> 
    ...
    <section id="content">
      <div class="inside">        
        <h2>Credito<span> Banjercito</span></h2>        
        <div class="img-box"><img src="images/banjercito.png"><span class="txt1">¿Que es Banjercito? </span> 
	        <p>Banjercito a lo largo de sus 65 años de existencia ha estado siempre atento a los requerimientos del Sector Militar, 
	        orientando sus esfuerzos a la diversificación de productos y servicios que permitan su atención integral,
	        ya sea a través de crédito o bien, del uso de instrumentos de ahorro e inversión, así como también, 
	        de otros servicios bancarios. </p>

        </div>        
      </div>
      <div class="requisitos">
        <a href="http://www.banjercito.com.mx/index.jsp?hd_ligaContenido=Productos_credito/prestamos_hipotecarios/menu_prestamos_hipotecarios.html" target="blank">
          Ir a la sección de prestamos hipotecarios Banjercito
        </a>        
      </div>
    </section>
  </div>
